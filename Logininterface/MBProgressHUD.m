...
//   CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading attributes:@{NSAttachmentAttributeName:detailsLabel.font} context:nil].size;
